...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error || "Giriş başarısız oldu (E-posta veya şifre hatalı).");
      }
    } catch (err) {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-slate-50 relative overflow-hidden px-4 font-sans">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-white">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900">Hesabınıza Giriş Yapın</h2>
            <p className="mt-2 text-sm text-slate-500">
              Veya{" "}
              <Link href="/register" className="font-semibold text-whatsapp hover:text-emerald-500 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <a href="#" className="text-sm font-medium text-whatsapp hover:text-emerald-500">Şifremi unuttum</a>
                </div>
                <input
                  name="password"
                  type="password"
